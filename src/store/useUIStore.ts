...
interface UIState {
  ...
  selectedBlockType: 'labelled' | 'unlabelled' | 'model' | 'rl-gridworld' | 'sensor' | 'condition' | 'logic' | 'fan' | 'alarm' | 'ac' | 'timer' | null
  ...
  setSelectedBlock: (id: string, type: 'labelled' | 'unlabelled' | 'model' | 'rl-gridworld' | 'sensor' | 'condition' | 'logic' | 'fan' | 'alarm' | 'ac' | 'timer') => void
