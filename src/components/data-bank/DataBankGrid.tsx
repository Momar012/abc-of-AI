...
export default function DataBankGrid({ items }: DataBankGridProps) {
  ...
  return (
    <div className="flex flex-col gap-1">
      {/* Header bar + selection banner: pinned to top of scroll area so bulk actions stay reachable while scrolling the grid */}
      <div className={`sticky top-0 z-10 -mx-1 px-1 glass-panel rounded-lg flex flex-col gap-1 ${count > 0 ? 'pb-1' : ''}`}>
